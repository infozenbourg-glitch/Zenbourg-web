        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-4">
                <p>Email: info.zenbourg@gmail.com</p>
                <p>Phone: +91 7772828027</p>
                <p> Adress: 105, Ab Rd, Sector C, Slice 5, Part 2, </p><p>Shalimar Township, Indore, Madhya Pradesh 452010, India</p>
              </div>
            </CardContent>
          </Card>
        </div>
