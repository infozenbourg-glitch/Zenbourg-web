...
const projectData = {
  "1": {
    ...
    description: "Clean, bold sports-oriented layout Easy navigation for product categoriesOptimized for mobile shopping",
    image: "/projects/image11.png",
    liveUrl: "  https://help.rebelsport.co.nz/hc/en-nz",
    completedDate: "March 2024",
    duration: "4 months",
    client: "TechFlow Inc.",
    budget: "$75,000",
    teamSize: "6 developers",
    technologies: [" HTML5", "JavaScript", "jQuery", "jQuery UI", "Font Awesome", "Salesforce Commerce Cloud", "PHP", "Google Maps API", "PayPalAPI "],
    challenge:
