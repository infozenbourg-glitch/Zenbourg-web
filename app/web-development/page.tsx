...
export default function WebDevelopmentPage() {
  return (<>
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-purple-900/20">
      ...
      <section className="relative overflow-hidden py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              <Badge className="mb-4 bg-blue-400  text-white px-4 py-2">
            ...
            >
              <Button
                size="lg"
                className="bg-blue-400 text-sm sm:text-base text-white px-8 py-3"
                asChild
              >
                <Link href="/book">
      ...
      <AnimatedSection>
        <section className="bg-gradient-to-r from-blue-600 via-purple-600 to-blue-800 bg-clip-text text-transparent mb-6 ">
          <div className="max-w-6xl mx-auto">
            <motion.div className="text-center mb-12" variants={fadeInUp}>
              <h2 className="text-3xl md:text-4xl font-bold text-blue mb-4">Sample ROI Calculation</h2>
                ...
                <table className="w-full">
                  ...
                  <tbody className="text-center">
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      <td className="py-4 px-4 font-medium text-left text-blue-600">Monthly Visitors</td>
                      <td className="py-4 px-4 text-blue-600">2,000</td>
                      <td className="py-4 px-4 text-green-600 font-bold">8,000</td>
                    </tr>
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      <td className="py-4 px-4 font-medium text-left text-blue-600">Conversion Rate</td>
                      <td className="py-4 px-4 text-blue-600">1% (20 leads)</td>
                      <td className="py-4 px-4 text-green-600 font-bold">2% (160 leads)</td>
                    </tr>
                    <tr className="border-b border-gray-100 dark:border-gray-700">
                      <td className="py-4 px-4 font-medium text-left text-blue-600">Average Order Value</td>
                      <td className="py-4 px-4 text-blue-600">$1,500</td>
                    ...
                    <tr className="bg-gradient-to-r from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20">
                      <td className="py-4 px-4 font-bold text-left text-blue-600">Monthly Revenue</td>
                      <td className="py-4 px-4 font-bold text-blue-600">$30,000</td>
                    ...
                    <tr className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900/20 dark:to-orange-900/20">
                      <td className="py-4 px-4 font-bold text-left text-blue-600">Net Increase</td>
                      <td className="py-4 px-4 text-blue-600">—</td>
            ...
            <motion.div variants={fadeInUp}>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <motion.div {...scaleOnHover}>
                  <Button
                    size="lg"
                    className="bg-blue-500  hover:from-blue-600 hover:to-purple-700 text-white px-8 py-3"
                    asChild
                  >
                    <Link href="/book">
